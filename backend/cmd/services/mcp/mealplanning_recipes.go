...
var recipesSchema = map[string]any{
	...
	"MinEstimatedPortions": floatField("Minimum estimated portions yielded (required)"),
	"MaxEstimatedPortions": floatField("Maximum estimated portions yielded (optional)"),
