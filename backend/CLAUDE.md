...
The platform framework (database, cache, observability, messaging, uploads, search, encoding, etc.) is an external dependency at `github.com/primandproper/platform-go`. Application code lives under `internal/`:
