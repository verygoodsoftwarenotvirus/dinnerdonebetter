...
RUN --mount=type=cache,target=/root/.cache/go-build ./scripts/build.sh -o /dinnerdonebetter github.com/verygoodsoftwarenotvirus/dinnerdonebetter/backend/cmd/services/api
